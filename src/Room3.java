...
public class Room3 implements Room {
	...
	public void play() throws InterruptedException {
		...
		System.out.println(   "3) Hell no, get them yourself.");
		selection = Room.getSelection(kbd, 3 );
		
		if( selection == 0 ) {
			//Follow echo, lawful good, combat.
			Room.addTraitPoint( Trait.LAWFUL, 2 );
			Room.addTraitPoint( Trait.GOOD, 2);
			...
			Room.addTraitPoint( Trait.CHAOTIC, 2 );
			Room.addTraitPoint( Trait.NEUTRAL2, 2);
			...
			Room.addTraitPoint( Trait.LAWFUL, 2 );
			Room.addTraitPoint( Trait.EVIL, 2);
			...
			if( selection == 0 ) {
				System.out.println( "\nYou come across a nearby bearing colorful fruit and decide to try one.");
				...
				System.out.println( "\nYou decide to wait for Echo to return.");
			}
			System.out.println( "\nEcho:  Wonderful news, " + Room.getPlayer().getName() + ": I've repaired my damaged vocalizer!");
