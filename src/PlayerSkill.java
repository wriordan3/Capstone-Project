...
public class PlayerSkill extends Skill {
	...
	public PlayerSkill(boolean isRanged, int level, int damage, int accuracy, double accuracyModifier, String name, String description, Trait desired,
	...
	public static List<PlayerSkill> getAllSkills() {
		...
		skills.add( new PlayerSkill( true, 1, 4, 12, 10, "Focused Shot", "Time the perfect shot for a higher chance to critical hit. Augments with Evil for 3x damage execution. (4 damage + weapon  | 12 + 1d10 to hit)", Trait.EVIL, new BiConsumer<PlayerSkill, Enemy>()  {
		...
		skills.add( new HealingSkill( 2, "First-Aid", "Echo dispenses a stimulant that heals the player for 10*level hitpoints. Augment to heal for 50% of max HP instead.",
